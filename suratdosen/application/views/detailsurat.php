  ...
  <div class="content-wrapper">
    ...
    <tr>
      <td><?php echo "Status Surat" ?></td>
        ...
        <a class="btn btn-info btn-sm" <?php echo anchor('admin/crud/update/'.$u->ID_SURAT,'Konfimasi'); ?></a>
        <a class="btn btn-danger btn-sm" href="http://localhost/suratdosen/admin/crud/list">Kembali</a> 
          Footer
        </div>
        <!-- /.card-footer-->
      </div>
