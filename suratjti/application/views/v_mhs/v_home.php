						...
						<li class="nav-item dropdown list-unstyled border border-primary text primary">
							...
							?>
								...
								<div class="dropdown-menu float-right" aria-labelledby="navbarDropdown">
									<a class="dropdown-item text-center" href="<?php echo base_url('mhs/login/logout'); ?>" data-toggle="modal" data-target="#logoutModal" id="keluar">
	...
	<section class="feature-bottom-area pt-20 pb-50 ">
		<div class="pb-4 pt-4 pl-4 pr-4 ml-4 mr-4 b-radius">
			<div class="row text-center justify-content-center pl-3 pr-3">
				<div class="col-sm ">
					...
					<div class="card-body">
						<img class="mt-2 mb-2 img-fluid" height="80px" src="<?php echo base_url('assets/asetmhs/assets/icon/dimanasaja.png') ?>"></img>
				...
				<div class="col-sm ">
					<div class="card shadow mt-2">
					<div class="card-body">
						<img class="mt-2 mb-2 img-fluid" height="80px" src="<?php echo base_url('assets/asetmhs/assets/icon/tracking.png') ?>"></img>
				...
				<div class="col-sm ">
					<div class="card shadow mt-2">
					<div class="card-body">
						<img class="mt-2 mb-2 img-fluid" height="80px" src="<?php echo base_url('assets/asetmhs/assets/icon/waktu.png') ?>"></img>
		...
		<section class="subscription-area mt-5">
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						<img src="<?php echo base_url() . 'assets/asetmhs/assets/images/logo.png' ?>" width='120px' class='mt-3 ml-3'></img>
					...
					<img src="<?php echo base_url() . 'assets/asetmhs/assets/images/phone_r.png' ?>" width='280px' height='250px' class='mt-5'></img>
				</div>
			</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- form login -->
					<form action="<?php echo base_url('mhs/login/aksi_login'); ?>" method="post">
	...
	<div class="modal fade" id="modalSelamat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<img src="<?php echo base_url("assets/asetmhs/assets/images/selamatdatang.png") ?>">
