...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $this->session->userdata("USERNAME_DSN"); ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('dosen/list');?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Menu</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('dosen/list');?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <td><?php echo $u->TRAKING_SURAT ?></td>
			<td> <a class="btn btn-info btn-sm" <?php echo anchor('dosen/update/'.$u->ID_SURAT,'Konfimasi'); ?></a> </td>
      <td> <a class="btn btn-info btn-sm" <?php echo anchor('dosen/detailSurat/'.$u->ID_SURAT,'Detail'); ?></a> </td>
		</tr>
		<?php } ?>
	</table>
            </div>
