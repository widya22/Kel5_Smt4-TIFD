  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
          ...
          <div class="card">
            ...
            <li class="nav-link active" ><a href="dtSrtProsesMK">Mata Kuliah</a></li>
...
$no = 1;
      ...
      <td><?php echo $u->TANGGAL_PENGAJUAN?></td>
			...
			<td> <a class="btn btn-info btn-sm" <?php echo anchor('admin/dsDiproses/'.$u->ID_SURAT,'Detail'); ?></a> 
      <a class="btn btn-warning btn-sm" href="<?php echo base_url('admin/print/'.$u->ID_SURAT);?>">Print</a> 
      <a class="btn btn-success btn-sm" <?php echo anchor('admin/updatestatus2/'.$u->ID_SURAT,'Selesai'); ?></a> </td>
