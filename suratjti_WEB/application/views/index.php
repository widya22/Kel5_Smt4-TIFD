...
<head>
  ...
  <title>JTI SURAT | AdminJTI</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="suratPending.php" class="nav-link">
                  <i class="nav-icon far fa-circle text-warning"></i>
                  <p>Menunggu Persetujuan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="suratTolak.php" class="nav-link">
                  <i class="nav-icon far fa-circle text-danger"></i>
                  <p>Surat Ditolak</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="suratSelesai.php" class="nav-link">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <p class="text-center">
                      <strong>Info Bulan Ini</strong>
                    </p>

                    <div class="progress-group">
                      Surat Survey Mata Kuliah
                    ...
                    <!-- /.progress-group -->
                    <div class="progress-group">
                      <span class="progress-text">Surat PKL</span>
